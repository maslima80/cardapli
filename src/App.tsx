...
import { mountVisualViewportListener } from "./utils/iosViewport";
...
const App = () => {
  // Mount iOS viewport listener on app startup
  useEffect(() => {
    const cleanup = mountVisualViewportListener();
    return cleanup;
  }, []);
    ...
    <HelmetProvider>
      <QueryClientProvider client={queryClient}>
        <TooltipProvider>
          ...
          <Sonner />
          <BrowserRouter>
          <div className="pb-16 md:pb-0 app-container">
          <Routes>
